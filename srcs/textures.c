...
static void	verify_texture(void *mlx, t_texture *tex, char *path)
{
	if (tex->width <= 0 || tex->height <= 0)
	{
		printf("Error\nInvalid dimensions: %s (%dx%d)\n",
